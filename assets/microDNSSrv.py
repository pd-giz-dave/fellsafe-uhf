""" history
    2021-02-24 DCN: created from https://github.com/jczic/MicroDNSSrv
    """
""" description
    Very simple DNS server that just responds to A queries (UDP on port 53)
    Basic example :
